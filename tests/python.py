...
class TestPolycapPhoton(unittest.TestCase):
    ...
    def test_photon_good_coords_leaks(self):
        ...
        self.assertAlmostEqual(photon.intleak[0].coords.x, 0.048777, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].coords.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].coords.z, 9., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].direction.x, -0.001078, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].direction.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].direction.z, 0.999999, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[0].weight[0], 0.000143, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].coords.x, 0.053113, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].coords.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].coords.z, 9., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].direction.x, -0.000511, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].direction.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].direction.z, 1., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[1].weight[0], 0.000352, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].coords.x, 0.027487, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].coords.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].coords.z, 9., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].direction.x, -0.006149, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].direction.y, 0., delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].direction.z, 0.999981, delta=1e-6)
        self.assertAlmostEqual(photon.intleak[2].weight[0], 0.000142, delta=1e-6)
        self.assertIsInstance(weights, np.ndarray)
        self.assertIsInstance(photon.get_exit_coords(), VectorTuple)
        self.assertIsInstance(photon.get_exit_direction(), VectorTuple)
        self.assertIsInstance(photon.get_exit_electric_vector(), VectorTuple)
