...
class TestPolycapSource(unittest.TestCase):
    ...
    def test_source_good_get_transmission_efficiencies(self):
        ...
        self.assertIsInstance(efficiencies.n_refl[0], double)
        self.assertIsInstance(efficiencies.exit_weights[0], np.ndarray)
        self.assertIsInstance(efficiencies.d_travel[0], double)
        self.assertIsInstance(efficiencies.src_start_coords[0], VectorTuple)
        self.assertIsInstance(efficiencies.start_coords[0], VectorTuple)
        self.assertIsInstance(efficiencies.start_direction[0], VectorTuple)
        self.assertIsInstance(efficiencies.start_elecv[0], VectorTuple)
