...
class TestPolycapSource(unittest.TestCase):
    ...
    def test_source_good_get_transmission_efficiencies(self):
        ...
        #exit_coords = list(efficiencies.exitcoords)
        #exit_direction = list(efficiencies.exitdirection)
        #exit_elecv = list(efficiencies.exitelecv)
        ...
        #self.assertIsInstance(efficiencies.nrefl[0], double)
