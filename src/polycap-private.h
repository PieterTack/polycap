...
#define BINSIZE 20.e-4 /* cm */
  ...
  int polycap_capil_segment(polycap_vector3 cap_coord0, polycap_vector3 cap_coord1, double cap_rad0, double cap_rad1, polycap_vector3 phot_coord0, polycap_vector3 phot_coord1, polycap_vector3 photon_dir, polycap_vector3 *interact_coord, polycap_vector3 *surface_norm, double *alfa, polycap_error **error);
